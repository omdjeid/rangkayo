...
class PosController extends Controller
{
    public function index(Request $request, CurrentTenant $currentTenant): Response
    {
        ...
        return Inertia::render('POS/Index', [
            ...
            'qris' => [
                'merchant_name' => $tenant->settings?->get('payment.qris.merchant_name') ?? '',
                'qris_string' => $tenant->settings?->get('payment.qris.manual_qris_string') ?? '',
                'image_url' => $tenant->settings?->get('payment.qris.image_url') ?? '',
                'status' => $tenant->settings?->get('payment.qris.status') ?? '',
            ],
